...
function displayAnalysisResults(analysis) {
    ...
    let html = `
        <div style="background: rgba(26, 188, 156, 0.05); padding: 20px; border-radius: 15px; border: 2px solid rgba(26, 188, 156, 0.2);">
            <h4 style="color: var(--primary-green); margin-bottom: 15px;">
                <i class="fas fa-chart-line"></i> Analysis Results
            </h4>
            <div style="font-size: 3rem; font-weight: 700; color: var(--primary-green); text-align: center; margin: 20px 0;">
                ${analysis.accuracy_score || analysis.overall_score?.score || 0}%
            </div>
            <p style="text-align: center; color: #666; font-size: 1.1rem;">
                ${analysis.overall_score?.feedback || 'Analysis complete'}
            </p>
        </div>
    `;
