    ...
    <div class="category-filters">
        ...
        <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
            ...
            <a href="{{ route('materials.index', array_filter(['search' => request('search'), 'owned' => request('owned')])) }}" 
               class="filter-btn {{ !request('category') && !request('owned') ? 'active' : '' }}">
                        ...
                        <div style="display: flex; gap: 10px;">
                            ...
                            @if(!$isStudent && auth()->user()->teacher && $material->teacher_id == auth()->user()->teacher->id)
                                <a href="{{ route('materials.edit', $material->material_id) }}" 
                                   style="display: flex; align-items: center; justify-content: center; padding: 10px 15px; background: rgba(52, 73, 94, 0.9); color: #ffffff; border-radius: 12px; text-decoration: none; font-weight: 600; font-size: 0.95rem; font-family: 'Cairo', sans-serif; transition: all 0.3s ease;"
                                   onmouseover="this.style.background='rgba(44, 62, 80, 1)'; this.style.transform='scale(1.05)'"
                                   onmouseout="this.style.background='rgba(52, 73, 94, 0.9)'; this.style.transform='scale(1)'">
