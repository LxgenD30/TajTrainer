                ...
                <div style="background: rgba(227, 216, 136, 0.05); padding: 20px; border-radius: 12px; border: 2px solid var(--primary-green); margin-bottom: 20px;">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <textarea name="biodata" rows="4"
                            style="width: 100%; padding: 12px; background: rgba(31, 39, 27, 0.5); color: var(--color-light); border: 2px solid var(--primary-green); border-radius: 8px; font-family: 'Cairo', sans-serif; font-size: 1rem; resize: vertical;">{{ old('biodata', $teacher->biodata) }}</textarea>
                    </div>
                </div>

                <!-- Change Password (Optional) -->
                <div style="background: rgba(227, 216, 136, 0.05); padding: 20px; border-radius: 12px; border: 2px solid var(--primary-green); margin-bottom: 20px;">
                    <h4 style="color: var(--gold); margin: 0 0 15px 0; font-size: 1.1rem;">🔒 Change Password (Optional)</h4>
                    
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; color: var(--gold); font-weight: 600; margin-bottom: 8px;">Current Password</label>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                        <div>
                            <label style="display: block; color: var(--gold); font-weight: 600; margin-bottom: 8px;">New Password</label>
                            <input type="password" name="new_password"
                                style="width: 100%; padding: 12px; background: rgba(31, 39, 27, 0.5); color: var(--color-light); border: 2px solid var(--primary-green); border-radius: 8px; font-family: 'Cairo', sans-serif; font-size: 1rem;">
                        </div>
                        <div>
                            <label style="display: block; color: var(--gold); font-weight: 600; margin-bottom: 8px;">Confirm New Password</label>
