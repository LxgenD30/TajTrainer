...
<div style="background: rgba(31, 39, 27, 0.7); border: 2px solid var(--color-dark-green); border-radius: 25px; padding: 25px; font-family: 'Cairo', sans-serif; box-shadow: 0 15px 35px rgba(0,0,0,0.4);">
    ...
    <div class="profile-container" style="display: grid; grid-template-columns: 280px 1fr; gap: 20px; align-items: start;">
        ...
        <div style="background: rgba(227, 216, 136, 0.03); border: 1px solid var(--color-dark-green); border-radius: 20px; padding: 30px 15px; text-align: center;">
            ...
            @if($teacher->title)
            <div style="color: var(--color-gold); font-size: 0.9rem; margin-bottom: 15px; font-weight: 600;">{{ $teacher->title }}</div>
            @endif
            ...
            <div style="text-align: left; border-top: 1px solid rgba(227, 216, 136, 0.1); padding-top: 20px; display: flex; flex-direction: column; gap: 15px;">
                ...
                <div>
                    <label style="display: block; color: var(--color-gold); font-size: 0.65rem; text-transform: uppercase; font-weight: 700; letter-spacing: 1px; margin-bottom: 2px;">Phone</label>
        ...
        <div style="display: flex; flex-direction: column; gap: 15px;">
            ...
            <div style="background: rgba(31, 39, 27, 0.4); border: 1px solid var(--color-dark-green); border-radius: 15px; padding: 20px;">
                <h4 style="color: var(--color-gold); margin: 0 0 10px 0; font-size: 1rem; display: flex; align-items: center; gap: 8px;">📝 About</h4>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px;">
                <div style="background: rgba(31, 39, 27, 0.4); border: 1px solid var(--color-dark-green); border-radius: 15px; padding: 20px; text-align: center;">
                    <div style="font-size: 2rem; margin-bottom: 5px;">🏫</div>
                    <div style="font-size: 1.8rem; font-weight: 800; color: #fff; line-height: 1;">{{ $teacher->classrooms->count() }}</div>
                    <div style="color: var(--color-gold); font-size: 0.75rem; font-weight: 700; text-transform: uppercase; margin-top: 5px;">Total Classes</div>
                </div>
                ...
                <div style="background: rgba(31, 39, 27, 0.4); border: 1px solid var(--color-dark-green); border-radius: 15px; padding: 20px; text-align: center;">
                    ...
                    <div style="color: var(--color-gold); font-size: 0.75rem; font-weight: 700; text-transform: uppercase; margin-top: 5px;">Total Students</div>
                </div>
            </div>

            <div style="background: rgba(31, 39, 27, 0.4); border: 1px solid var(--color-dark-green); border-radius: 15px; padding: 20px;">
                <h4 style="color: var(--color-gold); margin: 0 0 15px 0; font-size: 1rem;">🏫 My Classes</h4>
                <div style="display: flex; flex-direction: column; gap: 10px;">
                    ...
                    <div style="background: rgba(227, 216, 136, 0.05); border: 1px solid rgba(227, 216, 136, 0.1); border-radius: 10px; padding: 12px 18px; display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <a href="{{ route('classroom.show', $classroom) }}" style="color: var(--color-gold); text-decoration: none; font-size: 0.8rem; font-weight: 700; padding: 5px 12px; background: rgba(227, 216, 136, 0.1); border-radius: 6px; border: 1px solid var(--color-gold);">
                            View →
                        </a>
                    </div>
                    @empty
