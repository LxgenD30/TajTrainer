<?php $__env->startSection('title', 'Grade Submission'); ?>
<?php $__env->startSection('user-role', 'Teacher • Grade Assignment'); ?>
...
<div style="padding: 0;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 25px;">
        ...
        <div style="background: rgba(31, 39, 27, 0.6); backdrop-filter: blur(10px); border: 2px solid rgba(77, 139, 49, 0.3); border-radius: 15px; padding: 30px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3);">
            ...
            <div style="background: rgba(70, 63, 58, 0.4); padding: 15px; border-radius: 10px; margin-bottom: 20px;">
                ...
                <h4 style="color: var(--light-green); margin: 0 0 10px 0; font-size: 1rem;">
                    ...
                    <?php else: ?>
                        <?php echo e($submission->assignment->material ? $submission->assignment->material->title : 'Assignment'); ?>
            ...
            <div style="background: rgba(70, 63, 58, 0.4); padding: 15px; border-radius: 10px; margin-bottom: 20px;">
                ...
                ?>
                <?php if($audioExists): ?>
                <audio id="submissionAudio" controls preload="auto" style="width: 100%; margin-bottom: 10px; outline: none;" controlsList="nodownload" src="<?php echo e($audioUrl); ?>">
                    <source src="<?php echo e($audioUrl); ?>" type="<?php echo e($detectedMime); ?>">
                    ...
                    <source src="<?php echo e($audioUrl); ?>" type="audio/mp4">
                    <source src="<?php echo e($audioUrl); ?>" type="audio/x-m4a">
                    Your browser does not support the audio element.
                </audio>
                <?php else: ?>
                <div style="padding: 20px; background: rgba(231, 76, 60, 0.1); border: 2px solid #e74c3c; border-radius: 8px; color: #e74c3c;">
                    ⚠️ Audio file not found: <?php echo e($submission->audio_file_path); ?><br>
                ...
                <div style="display: flex; gap: 10px; align-items: center; margin-top: 8px;">
                    <div style="font-size: 0.75rem; color: var(--light-green); opacity: 0.6; flex: 1;">
                        📁 File: <?php echo e(basename($submission->audio_file_path)); ?>

                    </div>
                    <a href="<?php echo e($audioUrl); ?>" download="<?php echo e(basename($submission->audio_file_path)); ?>" 
                ...
                <script>
                    ...
                    if (audio) {
                        audio.addEventListener('error', function(e) {
                            ...
                            console.log('Attempted URL:', '<?php echo e($audioUrl); ?>');
                            console.log('MIME type:', '<?php echo e($detectedMime); ?>');
            ...
            <div style="background: linear-gradient(135deg, rgba(77, 139, 49, 0.15) 0%, rgba(31, 39, 27, 0.6) 100%); border: 2px solid rgba(77, 139, 49, 0.4); padding: 20px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.2);">
                ...
                <!-- Madd Analysis -->
                <?php if(isset($analysis['madd_analysis'])): ?>
                <div style="background: rgba(31, 39, 27, 0.6); border: 1px solid rgba(77, 139, 49, 0.3); padding: 18px; border-radius: 10px; margin-bottom: 15px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                        ...
                        ?>
                        <div style="padding: 8px 15px; background: rgba(77, 139, 49, 0.2); border: 2px solid <?php echo e($maddColor); ?>; border-radius: 10px;">
                            <span style="color: <?php echo e($maddColor); ?>; font-weight: 700; font-size: 1.3rem;"><?php echo e($analysis['madd_analysis']['percentage']); ?>%</span>
                        </div>
                    </div>
                    
                    <!-- Progress Bar -->
                    <div style="width: 100%; height: 8px; background: rgba(70, 63, 58, 0.5); border-radius: 10px; overflow: hidden; margin-bottom: 15px;">
                        <div style="width: <?php echo e($analysis['madd_analysis']['percentage']); ?>%; height: 100%; background: linear-gradient(90deg, <?php echo e($maddColor); ?>, <?php echo e($maddColor); ?>dd); transition: width 0.5s ease;"></div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-bottom: 15px;">
                        <div style="background: rgba(77, 139, 49, 0.15); padding: 12px; border-radius: 8px; text-align: center;">
                            ...
                            <div style="color: var(--gold); font-size: 1.5rem; font-weight: 700; margin-top: 5px;"><?php echo e($analysis['madd_analysis']['total_elongations']); ?></div>
                        </div>
                        <div style="background: rgba(76, 175, 80, 0.15); padding: 12px; border-radius: 8px; text-align: center;">
                            ...
                            <div style="color: #4caf50; font-size: 1.5rem; font-weight: 700; margin-top: 5px;"><?php echo e($analysis['madd_analysis']['correct_elongations']); ?></div>
                        </div>
                        <div style="background: rgba(244, 67, 54, 0.15); padding: 12px; border-radius: 8px; text-align: center;">
                            ...
                            <div style="color: #f44336; font-size: 1.5rem; font-weight: 700; margin-top: 5px;"><?php echo e(count($analysis['madd_analysis']['issues'])); ?></div>
                        </div>
                    </div>

                    <?php if(count($analysis['madd_analysis']['issues']) > 0): ?>
                    <div style="background: rgba(255, 152, 0, 0.08); border-left: 4px solid #ff9800; padding: 12px 15px; border-radius: 8px;">
                        <div style="color: #ff9800; font-size: 0.9rem; font-weight: 700; margin-bottom: 10px; display: flex; align-items: center; gap: 8px;">
                            <span>⚠️</span>
                            <span>Issues Detected (<?php echo e(count($analysis['madd_analysis']['issues'])); ?>)</span>
                        </div>
                        <div style="max-height: 200px; overflow-y: auto;">
                            <?php $__currentLoopData = $analysis['madd_analysis']['issues']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="background: rgba(31, 39, 27, 0.5); padding: 10px 12px; border-radius: 6px; margin-bottom: 8px; font-size: 0.85rem;">
                                <div style="display: flex; align-items: start; gap: 10px; margin-bottom: 6px;">
                                    <span style="background: #ff9800; color: #1f271b; font-weight: 700; padding: 2px 8px; border-radius: 4px; font-size: 0.75rem; min-width: 50px; text-align: center;">Word <?php echo e($issue['position'] ?? $index + 1); ?></span>
                                    <span style="color: var(--light-green); flex: 1; line-height: 1.5; font-weight: 600;"><?php echo e($issue['word'] ?? ''); ?></span>
                                </div>
                                <div style="color: #ffa726; font-size: 0.8rem; margin-bottom: 4px;"><?php echo e($issue['note'] ?? $issue['issue'] ?? 'Issue detected'); ?></div>
                                <div style="color: rgba(211, 255, 177, 0.7); font-size: 0.75rem;">💡 <?php echo e($issue['recommendation'] ?? ''); ?></div>
                            </div>
                ...
                <!-- Noon Sakin Analysis -->
                <?php if(isset($analysis['noon_sakin_analysis'])): ?>
                <div style="background: rgba(31, 39, 27, 0.6); border: 1px solid rgba(77, 139, 49, 0.3); padding: 18px; border-radius: 10px; margin-bottom: 15px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                        <div>
                        ...
                        ?>
                        <div style="padding: 8px 15px; background: rgba(77, 139, 49, 0.2); border: 2px solid <?php echo e($noonColor); ?>; border-radius: 10px;">
                            <span style="color: <?php echo e($noonColor); ?>; font-weight: 700; font-size: 1.3rem;"><?php echo e($analysis['noon_sakin_analysis']['percentage']); ?>%</span>
                        </div>
                    </div>
                    
                    <!-- Progress Bar -->
                    <div style="width: 100%; height: 8px; background: rgba(70, 63, 58, 0.5); border-radius: 10px; overflow: hidden; margin-bottom: 15px;">
                        <div style="width: <?php echo e($analysis['noon_sakin_analysis']['percentage']); ?>%; height: 100%; background: linear-gradient(90deg, <?php echo e($noonColor); ?>, <?php echo e($noonColor); ?>dd); transition: width 0.5s ease;"></div>
                    </div>

                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-bottom: 15px;">
                        <div style="background: rgba(77, 139, 49, 0.15); padding: 12px; border-radius: 8px; text-align: center;">
                            <div style="color: var(--light-green); font-size: 0.75rem; opacity: 0.8; text-transform: uppercase; letter-spacing: 0.5px;">Total Found</div>
                            <div style="color: var(--gold); font-size: 1.5rem; font-weight: 700; margin-top: 5px;"><?php echo e($analysis['noon_sakin_analysis']['total_occurrences']); ?></div>
                        </div>
                        <div style="background: rgba(76, 175, 80, 0.15); padding: 12px; border-radius: 8px; text-align: center;">
                            <div style="color: var(--light-green); font-size: 0.75rem; opacity: 0.8; text-transform: uppercase; letter-spacing: 0.5px;">Correct</div>
                            <div style="color: #4caf50; font-size: 1.5rem; font-weight: 700; margin-top: 5px;"><?php echo e($analysis['noon_sakin_analysis']['correct_pronunciation']); ?></div>
                        </div>
                        <div style="background: rgba(244, 67, 54, 0.15); padding: 12px; border-radius: 8px; text-align: center;">
                            <div style="color: var(--light-green); font-size: 0.75rem; opacity: 0.8; text-transform: uppercase; letter-spacing: 0.5px;">Issues</div>
                            <div style="color: #f44336; font-size: 1.5rem; font-weight: 700; margin-top: 5px;"><?php echo e(count($analysis['noon_sakin_analysis']['issues'])); ?></div>
                        </div>
                    </div>

                    <?php if(count($analysis['noon_sakin_analysis']['issues']) > 0): ?>
                    <div style="background: rgba(255, 152, 0, 0.08); border-left: 4px solid #ff9800; padding: 12px 15px; border-radius: 8px;">
                        <div style="color: #ff9800; font-size: 0.9rem; font-weight: 700; margin-bottom: 10px; display: flex; align-items: center; gap: 8px;">
                            <span>⚠️</span>
                            <span>Issues Detected (<?php echo e(count($analysis['noon_sakin_analysis']['issues'])); ?>)</span>
                        </div>
                        <div style="max-height: 200px; overflow-y: auto;">
                            <?php $__currentLoopData = $analysis['noon_sakin_analysis']['issues']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="background: rgba(31, 39, 27, 0.5); padding: 10px 12px; border-radius: 6px; margin-bottom: 8px; font-size: 0.85rem;">
                                <div style="display: flex; align-items: start; gap: 10px; margin-bottom: 6px;">
                                    <span style="background: #ff9800; color: #1f271b; font-weight: 700; padding: 2px 8px; border-radius: 4px; font-size: 0.75rem; min-width: 50px; text-align: center;">Word <?php echo e($issue['position'] ?? $index + 1); ?></span>
                                    <span style="color: var(--light-green); flex: 1; line-height: 1.5; font-weight: 600;"><?php echo e($issue['word'] ?? ''); ?></span>
                                </div>
                                <div style="color: #ffa726; font-size: 0.8rem; margin-bottom: 4px;"><?php echo e($issue['issue']); ?></div>
                                <div style="color: rgba(211, 255, 177, 0.7); font-size: 0.75rem;">💡 <?php echo e($issue['recommendation'] ?? ''); ?></div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <!-- Overall AI Feedback -->
                <?php if(isset($analysis['overall_score']['feedback'])): ?>
                <div style="background: linear-gradient(135deg, rgba(227, 216, 136, 0.15) 0%, rgba(227, 216, 136, 0.05) 100%); border: 2px solid rgba(227, 216, 136, 0.3); padding: 18px; border-radius: 10px; box-shadow: 0 4px 15px rgba(227, 216, 136, 0.1);">
                    ...
                    <p style="color: var(--light-green); margin: 0; font-size: 0.95rem; line-height: 1.8; padding-left: 45px;">
                        <?php echo e($analysis['overall_score']['feedback']); ?>
                ...
                <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid rgba(77, 139, 49, 0.3); display: flex; align-items: center; justify-content: space-between;">
                    ...
                    <div style="font-size: 0.75rem; color: var(--light-green); opacity: 0.6;">
                        <span>⏱️ <?php echo e($submission->created_at->diffForHumans()); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, rgba(227, 216, 136, 0.15) 0%, rgba(31, 39, 27, 0.8) 100%); border: 2px solid rgba(227, 216, 136, 0.4); padding: 25px; border-radius: 15px; margin-top: 20px; box-shadow: 0 6px 25px rgba(0, 0, 0, 0.3);">
                ...
                <?php if(isset($analysis['ai_feedback'])): ?>
                    <?php if(isset($analysis['ai_feedback']['summary'])): ?>
                    <div style="background: rgba(31, 39, 27, 0.6); padding: 20px; border-radius: 12px; margin-bottom: 15px; border-left: 4px solid #667eea;">
                        ...
                        <p style="color: var(--light-green); line-height: 1.8; margin: 0;"><?php echo e($analysis['ai_feedback']['summary']); ?></p>
                    </div>
                    <?php endif; ?>

                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 15px;">
                        <?php if(isset($analysis['ai_feedback']['strengths']) && count($analysis['ai_feedback']['strengths']) > 0): ?>
                        <div style="background: rgba(76, 175, 80, 0.15); padding: 18px; border-radius: 12px; border-left: 4px solid #4caf50;">
                            ...
                            <ul style="margin: 0; padding-left: 20px; color: var(--light-green); line-height: 1.8; font-size: 0.9rem;">
                                <?php $__currentLoopData = $analysis['ai_feedback']['strengths']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $strength): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li style="margin-bottom: 8px;"><?php echo e($strength); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                        <?php endif; ?>

                        <?php if(isset($analysis['ai_feedback']['improvements']) && count($analysis['ai_feedback']['improvements']) > 0): ?>
                        <div style="background: rgba(255, 152, 0, 0.15); padding: 18px; border-radius: 12px; border-left: 4px solid #ff9800;">
                            ...
                            <ul style="margin: 0; padding-left: 20px; color: var(--light-green); line-height: 1.8; font-size: 0.9rem;">
                                <?php $__currentLoopData = $analysis['ai_feedback']['improvements']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $improvement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li style="margin-bottom: 8px;">
                                    <?php if(is_array($improvement)): ?>
                                        <?php echo e($improvement['issue'] ?? ''); ?>

                                    <?php else: ?>
                                        <?php echo e($improvement); ?>
                    ...
                    <?php if(isset($analysis['ai_feedback']['next_steps'])): ?>
                    <div style="background: rgba(102, 126, 234, 0.15); padding: 18px; border-radius: 12px; border-left: 4px solid #667eea;">
                        ...
                        <p style="color: var(--light-green); line-height: 1.8; margin: 0; font-size: 0.9rem;"><?php echo e($analysis['ai_feedback']['next_steps']); ?></p>
                    </div>
                    <?php endif; ?>
                <?php else: ?>
                    ...
                    <div style="background: rgba(255, 107, 107, 0.15); padding: 20px; border-radius: 12px; border-left: 4px solid #ff6b6b; text-align: center;">
                        ...
                        <p style="color: var(--light-green); opacity: 0.8; margin: 0; line-height: 1.6; font-size: 0.9rem;">
                            <?php echo e($analysis['overall_score']['feedback'] ?? 'The Python audio analyzer failed to generate AI feedback. Check server logs for details about missing dependencies or execution errors.'); ?>
        ...
        <div style="background: rgba(31, 39, 27, 0.6); backdrop-filter: blur(10px); border: 2px solid rgba(77, 139, 49, 0.3); border-radius: 15px; padding: 30px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3);">
            ...
            <form method="POST" action="<?php echo e(route('teacher.submission.update.grade', $submission->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div style="background: linear-gradient(135deg, rgba(227, 216, 136, 0.2) 0%, rgba(77, 139, 49, 0.15) 100%); border: 2px solid rgba(227, 216, 136, 0.5); border-radius: 12px; padding: 18px; margin-bottom: 20px; box-shadow: 0 4px 15px rgba(227, 216, 136, 0.2);">
                    ...
                    <div style="background: rgba(31, 39, 27, 0.5); border-radius: 8px; padding: 12px;">
                        ...
                        <div style="margin-top: 10px; padding-top: 10px; border-top: 1px solid rgba(77, 139, 49, 0.3);">
                            <p style="color: var(--light-green); font-size: 0.85rem; margin: 0; opacity: 0.9;">
                                📊 AI Score: <strong><?php echo e($suggestedScore); ?></strong> | Your Score: <strong><?php echo e($submission->score->score); ?></strong>
                                <?php if(abs($suggestedScore - $submission->score->score) > ($submission->assignment->total_marks * 0.1)): ?>
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <div style="display: flex; gap: 10px; align-items: center;">
                        <input 
                            ...
                            name="score" 
                            min="0" 
                            max="<?php echo e($submission->assignment->total_marks); ?>"
                            step="0.5"
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p style="color: #ff6b6b; font-size: 0.85rem; margin-top: 5px;"><?php echo e($message); ?></p>
                    <?php unset($message);
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tajtrainerV2\resources\views/teachers/grade-submission.blade.php ENDPATH**/ ?>