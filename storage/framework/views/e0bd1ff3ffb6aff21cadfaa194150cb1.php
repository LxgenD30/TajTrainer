...
<?php $__env->startSection('title', 'Quran Practice'); ?>
<?php $__env->startSection('user-role', 'Student • Practice Mode'); ?>
...
<?php $__env->startSection('navigation'); ?>
    ...
    <a href="<?php echo e(route('student.practice')); ?>" class="nav-item active">
        <div class="nav-icon">
    ...
    async function startRecording() {
        try {
            ...
            mediaRecorder.onstop = async () => {
                ...
                try {
                    console.log('Sending request to:', '<?php echo e(route('student.practice.submit')); ?>');
                    
                    const response = await fetch('<?php echo e(route('student.practice.submit')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tajtrainerV2\resources\views/practice/index.blade.php ENDPATH**/ ?>