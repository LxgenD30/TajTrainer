...
<div class="classrooms-header">
    ...
    <a href="<?php echo e(route('classroom.create')); ?>" class="btn-create-classroom">
    ...
    <div class="classrooms-grid">
        <?php $__currentLoopData = $classrooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classroom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="classroom-card">
                ...
                <p class="classroom-description"><?php echo e(Str::limit($classroom->description ?? 'No description provided', 100)); ?></p>
                ...
                <div class="classroom-stats">
                    <div class="stat-box">
                        ...
                        <div class="stat-value"><?php echo e($classroom->students_count ?? 0); ?></div>
                    </div>
                    <div class="stat-box">
                        <div class="stat-label">Assignments</div>
                        <div class="stat-value"><?php echo e($classroom->assignments_count ?? 0); ?></div>
                    </div>
                    <div class="stat-box">
                        <div class="stat-label">Pending</div>
                        <div class="stat-value pending"><?php echo e($classroom->pending_assignments ?? 0); ?></div>
                    </div>
                    <div class="stat-box">
                        <div class="stat-label">Completed</div>
                        <div class="stat-value completed"><?php echo e($classroom->completed_assignments ?? 0); ?></div>
                    </div>
                </div>
