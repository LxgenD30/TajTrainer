...
<div class="classroom-header">
    <div class="classroom-title">
        <h1><?php echo e($classroom->class_name); ?></h1>
        <p><?php echo e($classroom->description ?? 'Master the rules of Quranic recitation through detailed analysis and practice.'); ?></p>
        
        <div class="classroom-stats">
            <div class="stat-item">
                <div class="stat-value"><?php echo e($assignments->count()); ?></div>
                <div class="stat-label">Assignments</div>
            </div>
            <div class="stat-item">
                <div class="stat-value"><?php echo e($classroom->students->count()); ?></div>
                <div class="stat-label">Students</div>
            </div>
            <div class="stat-item">
                <div class="stat-value"><?php echo e($classroom->teacher->name ?? 'Unknown'); ?></div>
                <div class="stat-label">Teacher</div>
            </div>
        </div>
        <div style="position: absolute; top: 30px; right: 40px; z-index: 10;">
            <a href="<?php echo e(route('student.classes')); ?>" class="back-link">
    ...
    <?php if($assignments->count() > 0): ?>
        <div class="assignments-list">
            <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="assignment-card <?php echo e($isGraded ? 'graded' : ($isSubmitted ? 'submitted' : ($isOverdue ? 'overdue' : 'pending'))); ?>">
                    <div class="assignment-header">
                        <div class="assignment-title">
                            <h4>
                                <?php if($assignment->surah): ?>
                                    <i class="fas fa-book-quran"></i> <?php echo e($assignment->surah); ?> 
                                    (<?php echo e($assignment->start_verse); ?><?php if($assignment->end_verse): ?>-<?php echo e($assignment->end_verse); ?><?php endif; ?>)
                                <?php else: ?>
                                    <i class="fas fa-file-alt"></i> <?php echo e($assignment->title ?? ($assignment->material ? $assignment->material->title : 'Assignment')); ?>

                                <?php endif; ?>
                            </h4>
                            <p><?php echo e(Str::limit($assignment->instructions, 150)); ?></p>
                        </div>
                        
                        <div class="assignment-status 
                            <?php echo e($isGraded ? 'status-graded' : ($isSubmitted ? 'status-submitted' : ($isOverdue ? 'status-overdue' : 'status-pending'))); ?>">
                            <?php if($isGraded): ?>
                                <i class="fas fa-check-circle"></i>
                                Graded: <?php echo e($score->score); ?>/<?php echo e($assignment->total_marks); ?>
                    ...
                    <div class="assignment-details">
                        <div class="assignment-meta">
                            ...
                            <span>
                                ...
                                Due: <?php echo e(\Carbon\Carbon::parse($assignment->due_date)->format('M d, Y g:i A')); ?>

                            </span>
                            <?php endif; ?>
                            <span>
                                <i class="fas fa-star"></i>
                                <?php echo e($assignment->total_marks); ?> points
                            </span>
                            <?php if($assignment->tajweed_rules): ?>
                        ...
                        <div class="assignment-actions">
                            <?php if($isGraded || $isSubmitted): ?>
                                <a href="<?php echo e(route('student.assignment.view', $assignment->assignment_id)); ?>" class="btn-primary">
                                    <i class="fas fa-eye"></i> View
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('student.assignment.submit', $assignment->assignment_id)); ?>" class="btn-primary">
                    ...
                    <?php if($isGraded && $score->feedback): ?>
                        <div class="feedback-section">
                            <h5><i class="fas fa-comment-dots"></i> Teacher Feedback</h5>
                            <div class="feedback-content"><?php echo e($score->feedback); ?></div>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
