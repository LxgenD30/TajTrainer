...
<?php $__env->startSection('user-role', 'Student • Submit Work'); ?>
...
<div class="info-grid">
    ...
    <div class="info-card">
        ...
        <div class="info-value">
            <?php if(is_array($assignment->tajweed_rules) && count($assignment->tajweed_rules) > 0): ?>
                <?php echo e($assignment->tajweed_rules[0]); ?>
...
<div class="content-card">
    ...
    <div class="instructions-box"><?php echo e($assignment->instructions); ?></div>
</div>
...
<div class="content-card">
    <div class="material-card">
        <h4 class="material-title">📚 Study Material: <?php echo e($assignment->material->title); ?></h4>
        <p style="color: #666; margin-bottom: 15px;">Review this material before submitting your assignment</p>
        <a href="<?php echo e(route('student.material.show', ['id' => $assignment->material->material_id, 'from' => 'assignment', 'assignment' => $assignment->assignment_id])); ?>" class="material-link">
...
<!-- Submission Form -->
<form method="POST" action="<?php echo e(route('student.assignment.store', $assignment->assignment_id)); ?>" enctype="multipart/form-data" id="submissionForm">
    <?php echo csrf_field(); ?>
    ...
    <div class="content-card">
        <div class="form-actions">
            <a href="<?php echo e(route('classroom.show', $assignment->class_id)); ?>" class="btn-cancel">
                ← Cancel
            </a>
        ...
        <?php if($assignment->is_voice_submission && config('services.assemblyai.api_key')): ?>
        <div class="ai-notice">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tajtrainerV2\resources\views/assignment/submit.blade.php ENDPATH**/ ?>