...
<?php $__env->startSection('user-role', 'Student • Learning Analytics'); ?>
...
<?php $__env->startSection('navigation'); ?>
    ...
    <a href="<?php echo e(route('student.progress')); ?>" class="nav-item active">
...
<div class="stats-grid">
    <div class="stat-card">
        <div class="stat-value"><?php echo e(number_format($overallProgress['accuracy'] ?? 0, 1)); ?>%</div>
        <div class="stat-label">Overall Accuracy</div>
    </div>
    <div class="stat-card">
        <div class="stat-value"><?php echo e($overallProgress['total_sessions'] ?? 0); ?></div>
        <div class="stat-label">Total Sessions</div>
    </div>
    <div class="stat-card">
        <div class="stat-value"><?php echo e($overallProgress['total_errors'] ?? 0); ?></div>
        <div class="stat-label">Errors Logged</div>
    </div>
    <div class="stat-card">
        <div class="stat-value"><?php echo e($overallProgress['total_correct'] ?? 0); ?></div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 30px;">
    ...
    <div class="modern-card">
        ...
        <div class="progress-ring">
            ...
            <div class="ring-text">
                <div class="ring-value"><?php echo e(number_format($overallProgress['accuracy'] ?? 0, 0)); ?>%</div>
    ...
    <div class="modern-card">
        ...
        <div class="trend-indicator">
            <div class="trend-arrow" style="color: <?php echo e($trendColor); ?>;"><?php echo e($trendIcon); ?></div>
            <div class="trend-value" style="color: <?php echo e($trendColor); ?>;"><?php echo e(abs($trendValue)); ?>%</div>
            <div class="trend-label"><?php echo e(ucfirst($trend)); ?> over time</div>
        </div>
    </div>
    ...
    <div class="modern-card">
        ...
        <?php if(count($topWeaknesses) > 0): ?>
            <?php $__currentLoopData = $topWeaknesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $weakness): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="weakness-item">
                    <div class="weakness-header">
                        <div class="weakness-name"><?php echo e($weakness->rule_name ?? 'Unknown Rule'); ?></div>
                        <div class="weakness-count"><?php echo e($weakness->error_count ?? 0); ?> errors</div>
                    </div>
                    <div style="color: #666; font-size: 0.9rem;">
                        <?php echo e($weakness->error_type === 'madd' ? 'Madd (Elongation) Rule' : 'Noon Sakin/Tanween Rule'); ?>
...
<!-- Recurring Errors -->
<?php if(count($recurringErrors) > 0): ?>
<div class="modern-card" style="margin-top: 30px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
        <?php $__currentLoopData = $recurringErrors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="background: linear-gradient(135deg, rgba(230, 126, 34, 0.05), rgba(211, 84, 0, 0.05)); border: 2px solid rgba(230, 126, 34, 0.2); border-radius: 15px; padding: 25px; text-align: center;">
                ...
                <div style="font-size: 1.3rem; font-weight: 600; color: #e67e22; margin-bottom: 8px;">
                    <?php echo e($error->rule_name ?? 'Unknown Rule'); ?>

                </div>
                <div style="font-size: 0.95rem; color: #666; margin-bottom: 12px;">
                    Occurred <strong><?php echo e($error->occurrence_count ?? 0); ?> times</strong>
                </div>
                <div style="font-size: 0.9rem; color: #999;">
                    <?php echo e($error->last_occurrence ?? 'Recently'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (overallRing) {
        const progressValue = <?php echo e(number_format($overallProgress['accuracy'] ?? 0, 0)); ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\tajtrainerV2\resources\views/students/progress.blade.php ENDPATH**/ ?>