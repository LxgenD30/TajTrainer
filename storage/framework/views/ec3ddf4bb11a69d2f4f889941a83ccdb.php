...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'TajTrainer Dashboard | Master Quranic Tajweed'); ?></title>
        ...
        <div class="container">
            <div class="header-container">
                ...
                <div class="user-profile" id="userProfile">
                    ...
                    <div class="user-info">
                        <h3><?php echo e(Auth::user()->name ?? 'User'); ?></h3>
                        <p><?php echo $__env->yieldContent('user-role', 'Student'); ?></p>
                    </div>
                    ...
                    <div class="profile-dropdown">
                        <?php if(Auth::user()->role_id == 3): ?>
                            <a href="<?php echo e(route('teachers.show', Auth::id())); ?>" class="dropdown-item">
                                <i class="fas fa-user-circle"></i>
                                <span>My Profile</span>
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('students.show', Auth::id())); ?>" class="dropdown-item">
                                <i class="fas fa-user-circle"></i>
                                <span>My Profile</span>
                            </a>
                        <?php endif; ?>
...
<?php /**PATH C:\laragon\www\tajtrainerV2\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>