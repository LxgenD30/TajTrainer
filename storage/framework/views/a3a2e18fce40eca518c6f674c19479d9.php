...
<?php $__env->startSection('user-role', 'Teacher • ' . $stats['total_classes'] . ' Classes'); ?>
    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo e($stats['total_classes']); ?></div>
            ...
            <div class="stat-card">
                <div class="stat-icon">📝</div>
                <div class="stat-value"><?php echo e($stats['total_assignments']); ?></div>
                ...
                <div class="submission-item">
                    <div class="submission-header">
                        ...
                        <div class="submission-details">
                            ...
                            <p><i class="fas fa-file-alt"></i> <?php echo e(Str::limit($submission->assignment->title, 25)); ?></p>
                        </div>
                    </div>
                    <div class="submission-footer">
                        ...
                        <a href="<?php echo e(route('teacher.submission.grade', $submission->id)); ?>" class="grade-btn">
