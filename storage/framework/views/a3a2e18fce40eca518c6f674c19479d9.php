...
<section class="welcome-section">
    <div class="welcome-content">
        ...
        <div class="streak-counter">
            ...
            <span><?php echo e($stats['total_classes']); ?> Active <?php echo e(Str::plural('Class', $stats['total_classes'])); ?></span>
        </div>
    </div>
</section>
        ...
        <ul class="activity-list">
            ...
            <li class="activity-item">
                ...
                <div class="activity-details">
                    ...
                    <p><?php echo e(Str::limit($submission->assignment->title, 40)); ?></p>
                </div>
            </li>
